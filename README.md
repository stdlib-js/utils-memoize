...
```javascript
import memoize from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-memoize@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-memoize/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/utils-memoize/actions/workflows/test.yml?query=branch:v0.2.2
